...
def save_picture_for_the_wall(params, posted_picture_data):
...
def post_picture_on_the_wall(saved_picture_data):
...
if __name__ == '__main__':
    ...
    posted_picture_data = post_picture(upload_url, params, file_name, proxies=proxies)
    saved_picture_data = save_picture_for_the_wall(params, posted_picture_data)
    print('вот принт')
    pprint(saved_picture_data)
    post_picture_on_the_wall(saved_picture_data)
    os.remove(file_name)
